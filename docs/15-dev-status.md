...
- Следующий шаг — Фаза 4.3 (персист: записи staging_trips/канона в Postgres+memory, outbox-автопромоушн, `sync_trips_attach`-джобы, выравнивание legacy-строк `RouteRow/TripRow` под DDL).
