...
- Следующий шаг — Фаза 4.1 (матчинг стоп→терминал осью ScorePair `stop_terminal` + golden_trips precision/recall в CI), затем 4.2 (staging + промоушен-транзакция=trip).
