...
> **Архив.** Датированный снапшот (2026-09-04) из прежней редакции плана:
> проверка MOTIS на роль геокодера/транзитного источника. Ссылки на нумерацию фаз
> (`14-plan.md:2` Фаза 0 / «до Фазы 1») в актуальном плане устарели — там Фаза 0 —
> миграция данных, Фаза 3/4 — скелет терминалов и trips. Документ сохранён как
> история валидации геокодера, не как источник правды по плану.
