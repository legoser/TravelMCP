...
-- Справочник регионов (коды реестра Минтранса): сид имён и density_class
-- (metro — МСК/СПб, urban — регионы с миллионниками, остальные rural).
-- Неизвестные коды UpsertRouteRegion складывает как (code, code) — маркер
-- для оператора, сид их не перезаписывает (ON CONFLICT DO NOTHING).
INSERT INTO regions(code, name_ru, density_class) VALUES
  ('01','Республика Адыгея', 'rural'),
  ('02','Республика Башкортостан', 'urban'),
  ('03','Республика Бурятия', 'rural'),
  ('04','Республика Алтай', 'rural'),
  ('05','Республика Дагестан', 'rural'),
  ('06','Республика Ингушетия', 'rural'),
  ('07','Кабардино-Балкарская Республика', 'rural'),
  ('08','Республика Калмыкия', 'rural'),
  ('09','Карачаево-Черкесская Республика', 'rural'),
  ('10','Республика Карелия', 'rural'),
  ('11','Республика Коми', 'rural'),
  ('12','Республика Марий Эл', 'rural'),
  ('13','Республика Мордовия', 'rural'),
  ('15','Республика Северная Осетия — Алания', 'rural'),
  ('16','Республика Татарстан', 'urban'),
  ('17','Республика Тыва', 'rural'),
  ('18','Удмуртская Республика', 'rural'),
  ('19','Республика Хакасия', 'rural'),
  ('20','Чеченская Республика', 'rural'),
  ('21','Чувашская Республика', 'rural'),
  ('22','Алтайский край', 'rural'),
  ('23','Краснодарский край', 'urban'),
  ('24','Красноярский край', 'urban'),
  ('25','Приморский край', 'rural'),
  ('26','Ставропольский край', 'rural'),
  ('27','Хабаровский край', 'rural'),
  ('28','Амурская область', 'rural'),
  ('29','Архангельская область', 'rural'),
  ('30','Астраханская область', 'rural'),
  ('31','Белгородская область', 'rural'),
  ('32','Брянская область', 'rural'),
  ('33','Владимирская область', 'rural'),
  ('34','Волгоградская область', 'urban'),
  ('35','Вологодская область', 'rural'),
  ('36','Воронежская область', 'urban'),
  ('37','Ивановская область', 'rural'),
  ('38','Иркутская область', 'rural'),
  ('40','Калужская область', 'rural'),
  ('42','Кемеровская область', 'rural'),
  ('43','Кировская область', 'rural'),
  ('44','Костромская область', 'rural'),
  ('45','Курганская область', 'rural'),
  ('46','Курская область', 'rural'),
  ('47','Ленинградская область', 'rural'),
  ('48','Липецкая область', 'rural'),
  ('50','Московская область', 'urban'),
  ('52','Нижегородская область', 'urban'),
  ('53','Новгородская область', 'rural'),
  ('54','Новосибирская область', 'urban'),
  ('55','Омская область', 'urban'),
  ('56','Оренбургская область', 'rural'),
  ('57','Орловская область', 'rural'),
  ('58','Пензенская область', 'rural'),
  ('59','Пермский край', 'urban'),
  ('60','Псковская область', 'rural'),
  ('61','Ростовская область', 'urban'),
  ('62','Рязанская область', 'rural'),
  ('63','Самарская область', 'urban'),
  ('64','Саратовская область', 'rural'),
  ('66','Свердловская область', 'urban'),
  ('67','Смоленская область', 'rural'),
  ('68','Тамбовская область', 'rural'),
  ('69','Тверская область', 'rural'),
  ('70','Томская область', 'rural'),
  ('71','Тульская область', 'rural'),
  ('72','Тюменская область', 'rural'),
  ('73','Ульяновская область', 'rural'),
  ('74','Челябинская область', 'urban'),
  ('75','Забайкальский край', 'rural'),
  ('76','Ярославская область', 'rural'),
  ('77','Москва', 'metro'),
  ('78','Санкт-Петербург', 'metro'),
  ('79','Еврейская автономная область', 'rural'),
  ('86','Ханты-Мансийский АО — Югра', 'rural'),
  ('90','Запорожская область', 'rural'),
  ('91','Республика Крым', 'rural'),
  ('92','Севастополь', 'rural'),
  ('93','Донецкая Народная Республика', 'rural'),
  ('94','Луганская Народная Республика', 'rural'),
  ('95','Херсонская область', 'rural')
...
-- Сид поселений для cold-start газетира (уровень 4, без родителя —
-- привязка к регионам позже, когда у regions появятся геометрии).
-- Имена + алиасы автовокзалов; живые поселения канона (ListSettlements)
-- перекрывают сид по совпадению имён. Идемпотентно (повторный прогон
-- Migrate пропускает существующие ru-имена).
DO $$
DECLARE
  r record;
  pid bigint;
...
BEGIN
  FOR r IN SELECT * FROM (VALUES
    ('Агинское', 114.5397554, 51.1052199, ARRAY['Агинское (Автостанция)']),
    ('Ангарск', 103.8919164, 52.551233100000005, ARRAY['Ангарск (Автостанция)']),
    ('Асино', 86.1544808, 56.9962498, ARRAY['Автовокзал Асино']),
    ('Ачинск', 90.5159474, 56.30351340000001, ARRAY['Автостанция Ачинск']),
    ('Бакчар', 82.08148320000001, 57.021024700000005, ARRAY['Автостанция Бакчар']),
    ('Балтийский', 93.52803540000001, 56.225842, ARRAY['Автовокзал "Балтийский"']),
    ('Баргузин', 109.63431240000001, 53.612028800000004, ARRAY['Баргузин (Автостанция)']),
    ('Барнаул', 83.75912360000001, 53.3523062, ARRAY['Автовокзал «Барнаул»']),
    ('Батурино', 85.1725979, 57.75175410000001, ARRAY['Автовокзал Батурино']),
    ('Белый', 91.38217270000001, 53.6004912, ARRAY['Автостанция Белый Яр']),
    ('Берёзовский', 86.26673530000001, 55.6697119, ARRAY['Берёзовский автовокзал']),
    ('Бийск', 85.2177, 52.5488, ARRAY['Бийский автовокзал']),
    ('Бичура', 107.59773580000001, 50.5902867, ARRAY['Бичура (Автовокзал)']),
    ('Богашёво', 85.20997170000001, 56.389416600000004, ARRAY['Аэропорт "Богашёво"']),
    ('Боготол', 89.52868106000001, 56.21141806000001, ARRAY['Автовокзал Боготол']),
    ('Бодайбо', 114.21661106000002, 57.85168118, ARRAY['Автовокзал Бодайбо']),
    ('Волчиха', 80.36727720000002, 52.01757064000001, ARRAY['Волчихинская автостанция']),
    ('Восточный', 93.0287543, 56.018260600000005, ARRAY['Автовокзал Восточный']),
    ('Горно-алтайск', 85.9415929, 51.9557025, ARRAY['Автовокзал Горно-Алтайск']),
    ('Городской', 82.9058602, 55.081411900000006, ARRAY['Городской аэропорт']),
    ('Гурьевск', 85.9652921, 54.286426466666676, ARRAY['Автовокзал Гурьевск']),
    ('Гусиноозер', 106.53723140000001, 51.2902697, ARRAY['Гусиноозер (Автовокзал)']),
    ('Емельяново', 92.68267510000001, 56.169469600000006, ARRAY['Емельяновский междугородный автовокзал']),
    ('Енисейск', 92.17397060000003, 58.45331984285714, ARRAY['Автовокзал Енисейск']),
    ('Жигалово', 105.1529691, 54.812777800000006, ARRAY['Жигалово (Автостанция)']),
    ('Жилой', 104.7391958, 52.823008300000005, ARRAY['Жилой массив "Аэропорт"']),
    ('Заиграево', 108.27026710000001, 51.835066600000005, ARRAY['Заиграево (Автовокзал)']),
    ('Заринского', 84.74646966666666, 53.99016941111111, ARRAY['Автовокзал Заринского АТП']),
    ('Зеленогорск', 86.95077950000001, 55.0055113, ARRAY['Зеленогорский автовокзал']),
    ('Зырянское', 86.616696, 56.833891400000006, ARRAY['Автостанция Зырянское']),
    ('Игарка', 84.70091740000001, 67.756684, ARRAY['Аэропорт Игарка']),
    ('Иркутск', 104.3051892, 52.289649600000004, ARRAY['Иркутск (Автовокзал)']),
    ('Кабанск', 106.65798960000001, 52.055820600000004, ARRAY['Кабанск (Автовокзал)']),
    ('Калачинск', 74.5770605, 55.044954000000004, ARRAY['Калачинский автовокзал']),
    ('Качуг', 105.87845370000001, 53.9632103, ARRAY['Качуг (Автостанция)']),
    ('Кемерово', 86.061, 55.3416, ARRAY['Автовокзал Кемерово']),
    ('Колпашево', 82.89623320000001, 58.3127781, ARRAY['Автовокзал Колпашево']),
    ('Косиха', 84.56559962857143, 53.361261400000004, ARRAY['Автостанция "Косиха"']),
    ('Краснозёрское', 79.2448375, 53.984891000000005, ARRAY['Автостанция "Краснозёрское"']),
    ('Красноярск', 92.90629307, 56.03306310000001, ARRAY['Красноярский междугородный автовокзал']),
    ('Купино', 77.2800861, 54.3588322, ARRAY['Автовокзал Купино']),
    ('Курагино', 92.66378490000001, 53.888288300000006, ARRAY['Автовокзал, автостанция Курагино']),
    ('Курумкан', 110.3229228, 54.328468, ARRAY['Курумкан (Автостанция)']),
    ('Кутулик', 102.7844019, 53.3525623, ARRAY['Кутулик (Автостанция)']),
    ('Кырен', 102.1307694, 51.681708300000004, ARRAY['Кырен (Автостанция)']),
    ('Кяхта', 106.45138800000001, 50.35513, ARRAY['Кяхта (Автовокзал)']),
    ('Лесосибирск', 92.5346111, 58.1757902, ARRAY['Автостанция Лесосибирск-Южный']),
    ('Листвянка', 104.8725885, 51.8470881, ARRAY['Листвянка (Автостанция)']),
    ('Маньчжурия', 117.42583780000001, 49.5976888, ARRAY['автовокзал Маньчжурия']),
    ('Мариинск', 87.7403834888889, 56.21281311111111, ARRAY['Мариинский автовокзал']),
    ('Международный', 92.4849286, 56.1815342, ARRAY['Международный аэропорт Красноярск']),
    ('Междуреченск', 90.2115, 52.8965, ARRAY['Автовокзал Междуреченск']),
    ('Минусинск', 91.70798020000001, 53.700578900000004, ARRAY['Автовокзал Минусинск']),
    ('Могойтуй', 114.9222295, 51.281642000000005, ARRAY['Могойтуй (Автостанция)']),
    ('Молчаново', 83.7607995, 57.581221000000006, ARRAY['Автостанция Молчаново']),
    ('Нарга', 83.56647914, 57.684254300000006, ARRAY['Автостанция Нарга']),
    ('Ново-кусково', 86.06152510000001, 57.055182200000004, ARRAY['Автовокзал Ново-Кусково']),
    ('Новосибирск', 83.0273816, 55.041057300000006, ARRAY['Новосибирский автовокзал-Главный']),
    ('Норильск', 87.34102060000001, 69.3245682, ARRAY['Аэропорт Норильск']),
    ('Омск', 73.2812115, 54.998610600000006, ARRAY['Омский Автовокзал']),
    ('Ордынское', 81.9088754, 54.363571, ARRAY['Автовокзал (р.п. Ордынское)']),
    ('Орлик', 99.82242458, 52.513164, ARRAY['Автовокзал с. Орлик']),
    ('Оса', 103.88192450000001, 53.387684500000006, ARRAY['Оса (Автостанция)']),
    ('Остановка:', 79.66426510000001, 54.4958892, ARRAY['Остановка: Автостанция с. Довольное']),
    ('Падун', 101.73109312, 56.295138480000006, ARRAY['Автостанция "Падун"']),
    ('Петровск-забайкальский', 108.84889290000001, 51.2645356, ARRAY['Петровск-Забайкальский (Автостанция)']),
    ('Петропавловка', 105.3303319, 50.611949, ARRAY['Петропавловка (Автостанция)']),
    ('Посёлок', 85.20375250000001, 56.390271500000004, ARRAY['Посёлок Аэропорт']),
    ('Припятово', 93.11517470000001, 56.956276900000006, ARRAY['Автовокзал Припятово']),
    ('Селенга', 107.574053, 51.833702800000005, ARRAY['Автостанция "Селенга"']),
    ('Слюдянка', 103.71989620000001, 51.6559448, ARRAY['Слюдянка (Автостанция)']),
    ('Советское', 85.41536123333334, 52.28895461666667, ARRAY['Автостанция с. Советское']),
    ('Станция', 83.67661716, 53.3441594, ARRAY['Автовокзал, Станция Западная']),
    ('Тальменка', 83.56480401111111, 53.821053400000004, ARRAY['Автовокзал Тальменка']),
    ('Таштагол', 87.8545782, 52.777185700000004, ARRAY['Таштагольский автовокзал']),
    ('Тисуль', 88.31569040000001, 55.763480900000005, ARRAY['Автостанция Тисуль']),
    ('Тогул', 85.91424181666667, 53.46930808333334, ARRAY['Тогульский автовокзал']),
    ('Толмачёво', 82.67106770000001, 55.008627800000006, ARRAY['Аэропорт Толмачёво']),
    ('Томск', 84.99143070000001, 56.4613482, ARRAY['Автовокзал Томск']),
    ('Топки', 85.61636920000001, 55.2752131, ARRAY['Автостанция Топки']),
    ('Турочак', 87.1153352, 52.2556463, ARRAY['Турочакский автовокзал']),
    ('Тюкалинск', 72.2116090857143, 55.87211848571429, ARRAY['Автовокзал Тюкалинск']),
    ('Тяжинский', 88.5164264, 56.114236000000005, ARRAY['Автостанция Тяжинский']),
    ('Улан-удэ', 107.57777510000001, 51.8302604, ARRAY['Улан-Удэ (Автовокзал)']),
    ('Улица', 92.9076519, 56.028034100000006, ARRAY['Улица Аэровокзальная']),
    ('Улёты', 112.48642794000003, 51.35456816, ARRAY['Автовокзал Улёты']),
    ('Усолье-сибирское', 103.6630437, 52.7543494, ARRAY['Усолье-Сибирское (Автостанция)']),
    ('Усть-ордынский', 104.7578191, 52.800825700000004, ARRAY['Усть-Ордынский (Автостанция)']),
    ('Хабары', 79.5352574, 53.6203415, ARRAY['с. Хабары (Автовокзал)']),
    ('Хилок', 82.8319582, 54.9462862, ARRAY['Хилокская автостанция']),
    ('Хоринск', 109.7629852, 52.1619462, ARRAY['Хоринск (Автовокзал)']),
    ('Центральный', 93.52159908333334, 56.2483756, ARRAY['Центральный Автовокзал']),
    ('Черлак', 74.8008758, 54.15037100000001, ARRAY['Автовокзал Черлак']),
    ('Черногорск', 91.33603777777776, 53.82148404444444, ARRAY['Автовокзал Черногорск']),
    ('Чита', 113.4959905, 52.0284114, ARRAY['Чита (Автовокзал)']),
    ('Шарыпово', 89.21510710000001, 55.5311815, ARRAY['Автостанция Шарыпово']),
    ('Шелехов', 104.0837348, 52.2051789, ARRAY['Шелехов (Автостанция)']),
    ('Шерловая', 116.34294430000001, 50.540142700000004, ARRAY['Автостанция Шерловая-1']),
    ('Энерголес', 92.53456637142857, 58.176233957142856, ARRAY['Автовокзал "Энерголес"']),
    ('Юго-западная', 82.87208460000001, 54.971523100000006, ARRAY['Юго-Западная автостанция']),
    ('Южная', 83.74242650000001, 53.2736018, ARRAY['Южная Автостанция']),
    ('Юрга', 84.90231533529413, 55.71324802941177, ARRAY['Автовокзал г.Юрга'])
  ) AS v(name, lon, lat, aliases) LOOP
    SELECT pn.place_id INTO pid FROM place_names pn
    WHERE pn.lang = 'ru' AND pn.name = r.name LIMIT 1;
    IF pid IS NULL THEN
      INSERT INTO places(parent_id, admin_level, level, geom)
      VALUES (NULL, 8, 4, ST_SetSRID(ST_MakePoint(r.lon, r.lat), 4326)::geography)
      RETURNING id INTO pid;
      INSERT INTO place_names(place_id, lang, name, normalized)
      VALUES (pid, 'ru', r.name, lower(r.name))
      ON CONFLICT DO NOTHING;
    END IF;
    FOREACH a IN ARRAY r.aliases LOOP
      INSERT INTO place_names(place_id, lang, name, normalized)
      VALUES (pid, 'ru', a, lower(a))
      ON CONFLICT DO NOTHING;
    END LOOP;
  END LOOP;
END $$;
