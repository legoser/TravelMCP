...
// Зеркало сида migrations/001_initial.sql (таблица regions): канон имён живёт
// в БД, карта нужна memory-стору тестов и проверяется TestRegionSeedMatchesMigration.
