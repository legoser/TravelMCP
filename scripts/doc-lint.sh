...
for v in HTTP_ADDR DATABASE_DSN PROVIDERS_ENABLED INTERCITY_REESTR_PATH ADMIN_TOKEN SYNC_LOG_DIR SYNC_COVERAGE_GATE SYNC_ATTACH_WAIT SYNC_TRIPS_CHURN_THRESHOLD SYNC_TRIPS_MAX_SPEED_KMH VERIFICATION_SCORE_MARGIN VERIFICATION_SCORE_AMBIGUITY GEOCODER_TTL_VERIFIED GEOCODER_TTL_DISPUTED; do
