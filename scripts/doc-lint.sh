...
for v in HTTP_ADDR DATABASE_DSN PROVIDERS_ENABLED INTERCITY_REESTR_PATH ADMIN_TOKEN SYNC_LOG_DIR SYNC_COVERAGE_GATE SYNC_TRIPS_CHURN_THRESHOLD GEOCODE_TTL_VERIFIED GEOCODE_TTL_DISPUTED; do
